...
import { addEducation } from "../../apis/auth";
import { useAuth, useNotification } from "../../hooks";
import LiveSearchInput from "./LiveSearchInput";

/* eslint-disable react/prop-types */
function ModalAddEducation({ onCloseModalAddEducation }) {
  ...
  const handleSave = async () => {
    const { error, message } = await addEducation({
      universityId: inputInfo.universityId,
      ...
      fieldOfStudy: inputInfo.fieldOfStudy,
    ...
    >
      ...
      >
        ...
        <button
          ...
          onClick={onCloseModalAddEducation}
        >
          <svg
            role="none"
            aria-hidden="true"
        ...
        <div className="main-page artdeco-modal__header ember-view">
          <h2 id="profile-edit-form-page-header">Add education</h2>
        </div>
        <div
                ...
                <div className="main-page pt5">
                  ...
                  <div className="main-page fb-dash-form-element-group">
                    <div className="main-page fb-dash-form-element-group-elements fb-dash-form-element-group-elements--horizontal">
                      ...
                      >
                        <div>
                          <div className="main-page artdeco-text-input artdeco-text-input--type-text artdeco-text-input--color-default ember-view">
