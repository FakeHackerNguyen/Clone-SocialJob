...
function Logo() {
  return (
    <NavLink
      to="/"
      className="homepage nav__logo-link link-no-visited-state z-1 mr-auto babybear:z-0 babybear:mr-0 babybear:flex-1 hover:no-underline focus:no-underline active:no-underline"
    >
      <span className="homepage sr-only">LinkedIn</span>
      <i
        className="homepage block text-color-brand w-[84px] h-[21px] papabear:w-[135px] papabear:h-[34px] order-1 lazy-loaded"
        ...
        >
          ...
          >
            <path
              ...
              className="homepage bug-text-color"
          ...
          <g className="homepage linkedin-text">
            <path
