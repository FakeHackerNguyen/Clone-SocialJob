...
function DateFormField({ htmlFor, label, classes, name, onChange }) {
  return (
    <div
      className={`location-sign-up ${classes} onboarding-profile-edu__form-field onboarding-profile-edu__school-years-form-field flex-grow-1`}
    >
      <div className="location-sign-up onboarding-profile-form-field">
        ...
        <span>
          <select
            ...
            className="location-sign-up onboarding-input"
            aria-required="true"
            required=""
            name={name}
            onChange={onChange}
